...
EXTERN_C
BOOL WINAPI QueryThreadCycleTime(_In_ HANDLE ThreadHandle, _Out_ PULONG64 CycleTime)
...
EXTERN_C
BOOL WINAPI QueryProcessCycleTime(_In_ HANDLE ProcessHandle, _Out_ PULONG64 CycleTime)
#ifdef YY_Thunks_Defined
    ;
#else
{
